...
- Remaining owner decisions: actual personal alternate names, official organization profile URLs, qualification-verification URLs and pre-existing factual-review items. A joined query/page export is needed to verify actual GSC query-to-URL attribution.
